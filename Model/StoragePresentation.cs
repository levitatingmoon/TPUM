...
namespace Model
{
    public class StoragePresentation
    {
        ...
        public List<IItemPresentation> GetItems()
        {
            ...
            {
                items.Add(IItemPresentation.Create(item.Name, item.Price, item.Id, item.Type));
            }
            return items;
        }
        ...
        private void OnItemRemoved(object? sender, IShopItem e)
        {
            ...
            IItemPresentation Item = (IItemPresentation.Create(e.Name, e.Price, e.Id, e.Type));
        ...
        private void OnTransactionSucceeded(object? sender, List<IShopItem> e)
        {
            ...
            {
                IItemPresentation ItemPresentation = IItemPresentation.Create(shopItem.Name, shopItem.Price, shopItem.Id,
                     shopItem.Type);
